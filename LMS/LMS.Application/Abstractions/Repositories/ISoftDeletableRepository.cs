...
{
    /// <summary>
    /// Defines a generic repository interface for entities that support soft deletion,
    /// in addition to common data access operations. This interface provides methods
    /// for retrieving, adding, and deleting entities (both hard and soft),
        ...
        where TEntity : class
    {
        ...
        /// Use with extreme caution, as this operation is irreversible and removes data from the database.
        /// </summary>
        ...
        /// <summary>
        /// Marks an entity as "deleted" logically, typically by setting an 'IsDeleted' flag to true.
        /// The entity remains in the database but is generally excluded from normal queries.
        /// </summary>
